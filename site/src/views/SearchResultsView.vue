<template>
  <main class="container-lg">
    <div class="mx-4 me-md-5">
      ...
      <div
        class="inner cover d-flex flex-column align-items-center justify-content-center gap-4 pt-4 mx-5"
        v-if="searchedMachines.length === 0"
      >
        <h5 class="lead text-center mt-6 mb-6 my-auto">
          No machines matching your search query was found. Click on the button below to access the available washing
          machines and to reserve one.
        </h5>
