            ...
            <div>
              ...
              <div v-if="createAddress">
                <div class="row">
                  ...
                  <!-- Text information to warn the user to enter valid address -->
                  <div class="col-md-12">
                    <small class="form-text text-muted">
                      Please make sure to enter a valid address, with correct coordinates! (zip code, city, country...)
                    </small>
                  </div>
                </div>
              </div>
...
function validDateTime(dateTime) {
  // Check if dateTime is not null and is greater than the current date and time
  const now = new Date();
