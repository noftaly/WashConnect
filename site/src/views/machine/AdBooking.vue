    ...
    <main class="container my-5">
        ...
        <div>
            ...
            <div class="dropdown d-flex justify-content-center">
                <button class="btn btn-primary dropdown-toggle" type="button" id="hoursDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {{ selectedHour || "Hours" }}
                </button>
                ...
                <button class="btn btn-primary dropdown-toggle" type="button" id="minutesDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="mt-5">
            <div class="alert alert-warning alert-sm text-center " role="alert">
                By clicking the button below, x € will be deducted from your balance.
            </div>
            <div class="d-flex justify-content-center">
